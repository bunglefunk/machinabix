...
public class ManganeseIngotItem extends MachinabixModElements.ModElement {
	@ObjectHolder("machinabix:manganese_ingot")
	public static final Item block = null;
	public ManganeseIngotItem(MachinabixModElements instance) {
		super(instance, 2);
	}
