...
public class SodiumIngotItem extends MachinabixModElements.ModElement {
	@ObjectHolder("machinabix:sodium_ingot")
	public static final Item block = null;
	public SodiumIngotItem(MachinabixModElements instance) {
		super(instance, 1);
	}
